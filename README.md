...
- [☁️ AWS Cloud Projects](https://github.com/jtlutabingwa/AWS-Cloud-Projects) — Hands-on AWS projects covering core cloud services.
  ...
  - [AI Smart Assistant](https://github.com/jtlutabingwa/AWS-Cloud-Projects/tree/main/ai-smart-assistant) - Built an AI Assistant for an example HR dept using Bedrock, OpenSearch, DynamoDB, Lambda.
