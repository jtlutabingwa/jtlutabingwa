...
**Security**
- [🕵️ Holmes CTF 2025: Write-Up](https://github.com/jtlutabingwa/Holmes-CTF-2025) — Official write-up covering forensic and security challenges from the competition.
...
- [☁️ AWS Cloud Projects](https://github.com/jtlutabingwa/AWS-Cloud-Projects) — Hands-on AWS projects covering core cloud services.
  ...
  - [AI Smart Assistant](https://github.com/jtlutabingwa/AWS-Cloud-Projects/tree/main/ai-smart-assistant) - Built an AI Assistant for an example HR dept using Bedrock, OpenSearch, DynamoDB, and Lambda.
